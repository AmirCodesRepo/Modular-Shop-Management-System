...
$.validator.addMethod("extensionfilelimitation",
    function (value, element, params) {
        debugger;
        if (this.optional(element)) {
            return true;
        ...
        const allowed = params.toLowerCase().split(',').map(x => x.trim());

        return allowed.includes(extension);
    });
//jQuery.validator.unobtrusive.adapters.addBool("extensionfilelimitation");
$.validator.unobtrusive.adapters.addSingleVal(
    "extensionfilelimitation",
    "extensions"
);
