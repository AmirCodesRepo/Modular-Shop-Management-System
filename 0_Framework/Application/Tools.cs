...
namespace _0_Framework.Application
    ...
    public static class Tools
    {
        ...
        private static readonly string[] PersianNumbers = { "۰", "۱", "۲", "۳", "۴", "۵", "۶", "۷", "۸", "۹" };
        ...
        public static string ToEnglishNumber(this string strNum)
        {
            var cash = strNum;
            for (var i = 0; i < 10; i++)
                cash = cash.Replace(PersianNumbers[i], EnglishNumbers[i]);
            return cash;
        }
        ...
        public static string ToPersianNumber(this int intNum)
        {
            ...
            for (var i = 0; i < 10; i++)
                chash = chash.Replace(EnglishNumbers[i], PersianNumbers[i]);
            return chash;
        }
